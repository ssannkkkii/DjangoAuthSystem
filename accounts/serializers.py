...
from django.utils.http import urlsafe_base64_encode, urlsafe_base64_decode, urlsafe_base64_decode
...
class PasswordResetRequestSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if User.objects.filter(email=email).exists():
            ...
            relative_link = reverse('password-confirm', kwargs={'uidb64': uidb64, 'token': token})
...
class SetNewPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        try:
            ...
            return AuthenticationFailed("invalid credentials try again.")
